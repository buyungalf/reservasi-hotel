                    ...
                    <tr>
                      ...
                      <td>
                            <div class="input-group-btn">
                              <a href="<?= $admin_url; ?>main.php?pages=edit_kamar&id_kamar=<?= $oj['id_kamar']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                              <a href="<?= $admin_url; ?>pages/kamar/aksi_hapus.php?id_kamar=<?= $oj['id_kamar']; ?>" class="btn btn-danger"><i class="fas fa-power-off"></i></a>
                            </div>
                          </td>
                    </tr>
                    <?php $i++;} ?> 
