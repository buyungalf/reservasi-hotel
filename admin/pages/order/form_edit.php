            ...
            <div class="card card-info">
              ...
              <form method="post" action="pages/order/aksi_edit.php" class="form-horizontal">
                <?php
                  ...
                  $query = mysqli_query($koneksi, "SELECT * FROM tb_order WHERE id='$id_order'");
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama_order" value="<?= $o['nm_order'] ?>" placeholder="Nama Barang Order">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Harga Barang</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="harga" value="<?= $o['harga'] ?>" placeholder="Harga Barang">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control select2" name="jenis_order" style="width: 100%;">
                        ...
                        ?>                          
                          <option value="<?php echo $o['id_jenis_order']; ?>">
                            <?php echo $o['jenis_order']; ?>
                          </option>
                          <?php } ?>
                      </select>
                    </div>
